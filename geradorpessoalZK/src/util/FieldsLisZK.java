...
/**
 * 
 * @author diego Classe responsavel por fazer os campos de busca do lis.zul
 */
public class FieldsLisZK {
	/**
	 ...
	 */
	public static String contruirField(Field field, String idtela, String nomeEntidade) {
	...
	/*
	 * private String getRadioBox(Field field,String idtela) { String campo;
