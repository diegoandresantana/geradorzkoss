...
public class CombosCadZK {
	 ...
	 */
	public static String getComboBox(Field field, String idtela) {
		String campo = "";
		campo += "\n<hbox>\n 	";
		...
		campo+= "	<comboitem self=\"@{each=" + field.getName().toLowerCase()
				...
				+ "}\"/>";
		campo += "</combobox>";
		if(field.getAnnotation(ZKCombo.class).addbutton())
	 ...
	 * @return campo completo
	 */
	public static String getComboBoxFix(Field field, String idtela) {
		String campo = "";
